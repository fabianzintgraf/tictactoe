...
describe('When player store is initialized', function() {
  ...
  describe('When player1 updates his name', function() {
     beforeEach(function() {
      playersStore.onAppDispatch({ type: updatePlayerActionTypes.UPDATED, payload: { playerIndex: 0, name: 'player 1 name'} });
    });
    ...
    describe('When player1 updates his name', function() {
      beforeEach(function() {
        playersStore.onAppDispatch({ type: updatePlayerActionTypes.UPDATED, payload: { playerIndex: 1, name: 'player 2 name'} });
      });
